...
private def proofInfo : Json :=
  Json.mkObj [
    ("systems", Json.arr (#[ "FastProofTheory.Proof.NJ", "FastProofTheory.Proof.NK", "FastProofTheory.Proof.LJ", "FastProofTheory.Proof.LK", "FastProofTheory.Proof.LinearLogic" ].map Json.str)),
    ("syntax", Json.str "NJ/NK/LJ/LK use Mathlib.ModelTheory.Syntax; LinearLogic uses FastProofTheory.Proof.LinearFormula.")
  ]
