import FastProofTheory.ProofTheory.Natural.IPC.Examples
import FastProofTheory.IPC.Countermodel
import FastProofTheory.IPC.Soundness

namespace FastProofTheory.ProofTheory.Natural.IPC.Audit
...
private def atomFalseVal : Atom → Fin 1 → Bool :=
  fun _ _ => false
...
private def atomFalseModel : FiniteModel Atom where
...
end FastProofTheory.ProofTheory.Natural.IPC.Audit
